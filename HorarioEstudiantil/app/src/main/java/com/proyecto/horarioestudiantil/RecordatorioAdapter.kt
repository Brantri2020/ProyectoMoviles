...
class RecordatorioAdapter(private val context: Activity, private val recordatorio: ArrayList<RecordatorioModelClass>)   : BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val txtDescripcionRecordatorio=rowView.findViewById<TextView>(R.id.txtDescripcionRecordatorio)
